...
<body>
    <div class="logo">
        ...
        <a href="{{$settings->vk_url}}" class="vk" target="_blank"><span>Join the group </span><i class="fab fa-vk"></i></a>
    </div>
</body>
@else
@if(Auth::user() && $u->ban)
...
<!DOCTYPE html>
   <html lang="en">
    ...
    <link href="/img/luck2x-fav.png" rel="shortcut icon"> 
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/socket.io/2.1.1/socket.io.js?v={{ time() }}"></script> 
        <script type="text/javascript" src="/js/perfect-scrollbar.min.js"></script>
        <script type="text/javascript" src="/js/wnoty.js?v={{ time() }}"></script>
        <script type="text/javascript" src="/js/snowfall.jquery.js?v={{ time() }}"></script>
            ...
            <div class="header" style="right:0px;z-index: 1003;">
                    ...
                    <div class="header-block">
                        ...
                        <div class="top-nav-wrapper">
                            ...
                            <ul class="top-nav">
                                ...
                                <li>
                                    <a class="{{ Request::is('rank') ? 'isActive' : '' }}" href="/rank">
               ...
               <div class="left-sidebar">
                <ul class="side-nav">
                    ...
                    <!--
                    <li class="{{ Request::is('slots') ? 'current' : '' }}">
                        <a class="" href="/slots">
                    ...
                    <li class="{{ Request::is('wheel') ? 'current' : '' }}">
                        <a class="" href="/wheel">
                            <svg class="icon">
                            ...
                            <div class="row">
                                <div class="col col-3 col-md-6">
                                    ...
                                    <svg class="icon-statistics"><use xlink:href="/img/symbols.svg#icon-stats-user"></use></svg>
                                        <div class="counter-num">{{$stats['countUsers']+2736}}</div>
                                ...
                                <div class="col col-3 col-md-6">
                                    ...
                                    <svg class="icon-statistics"><use xlink:href="/img/symbols.svg#icon-stats-add-user"></use></svg>
                                        <div class="counter-num">{{$stats['countUsersToday']+128}}</div>
                                ...
                                <svg class="icon-statistics" style="fill: #d8edf9;"><use xlink:href="/img/symbols.svg#icon-stats-card"></use></svg>
                                    <div class="counter-num">{{$stats['totalWithdraw']+74839}}</div>
                                        ...
                                        <div>
                                            <button class="user-link" type="button" data-id="{{$sms['unique_id']}}">
                                                <span class="sanitize-name" style="{{$sms['userStyle']}}">
                                                    {!!$sms['rank']!!}
                                                  <span class="sanitize-text">@if($sms['admin']) <span class="admin-badge isAdmin" data-toggle="tooltip" data-placement="top" title="Administrator">
                                                    <span class="">
                                                      <svg class="icon icon-a">
                                                        <use xlink:href="/img/symbols.svg#icon-a"></use>
                                                      </svg>
                                                    </span>
                                                  </span> Moderator @elseif($sms['moder']) <span class="admin-badge isModerator" data-toggle="tooltip" data-placement="top" title="Moderator">
                                                    <span class="">
               ...
               <div class="modal-content">
                ...
                <div class="faucet-container">
                    ...
                    <div class="faucet-modal-form">
                        <div class="faucet-reload"><span>Min. amount</span> <span>{{$settings->exchange_min}}</span> <svg class="icon icon-coin bonus"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
                    </div>
                    <div class="faucet-modal-form">
                        <div class="faucet-reload"><span>Course</span> <span>{{$settings->exchange_curs}}</span> <svg class="icon icon-coin bonus"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg> = <span>1</span> <svg class="icon icon-coin balance"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
                    </div>
                    <div class="form-row">
                        <label>
