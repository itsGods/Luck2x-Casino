...
<html lang="en">
        <head>
                <meta charset="utf-8" />
                <title>{{$settings->sitename}} | Admin Panel</title>
        ...
        <body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
                <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
                        <div class="kt-header-mobile__logo center">
                                <a href="/admin">
                                        <img alt="Logo" src="/dash/img/luck2x-logo.png" />
                                </a>
                        </div>
                ...
                <div class="kt-grid kt-grid--hor kt-grid--root">
                        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
                                ...
                                <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
                                        ...
                                        <div class="kt-aside__brand kt-grid__item center" id="kt_aside_brand">
                                        ...
                                        <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                                                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                                                        <ul class="kt-menu__nav ">
                                                                ...
                                                                <li class="kt-menu__item {{ (Request::is('admin/users') || Request::is('admin/user/*')) ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                 ...
                                                                 @if($u->superadmin)
                                                                 <li class="kt-menu__item {{ Request::is('admin/bots') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                ...
                                                                @endif
                                                                <li class="kt-menu__item {{ Request::is('admin/bonus') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                 ...
                                                                 @if($u->superadmin)<li class="kt-menu__item {{ Request::is('admin/giveaway') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                        <a href="/admin/giveaway" class="kt-menu__link">
                                                                                ...
                                                                                <span class="kt-menu__link-text">Giveaways</span>
                                                                        </a>
                                                                </li>@endif
                                                                <li class="kt-menu__item {{ Request::is('admin/promo') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                        <a href="/admin/promo" class="kt-menu__link">
                                                                                ...
                                                                                <span class="kt-menu__link-text">Promo codes</span>
                                                                        </a>
                                                                </li>
                                                                ...
                                                                @endif
                                                                <li class="kt-menu__item {{ Request::is('admin/withdraws') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                        <a href="/admin/withdraws" class="kt-menu__link">
                                                                                ...
                                                                                <span class="kt-menu__link-text">Conclusions</span>
                                                                        </a>
                                                                </li>
                                                                <li class="kt-menu__item {{ Request::is('admin/ranks') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                        <a href="/admin/ranks" class="kt-menu__link">
                                                                                <span class="kt-menu__link-icon">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                                        <rect id="bound" x="0" y="0" width="24" height="24"/>
                                                                                ...
                                                                                <span class="kt-menu__link-text">Ranks</span>
                                                                        </a>
                                                                </li>
                                                                <li class="kt-menu__item {{ Request::is('admin/styles') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                        <a href="/admin/styles" class="kt-menu__link">
                                                                                <span class="kt-menu__link-icon">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                                        <polygon id="Bound" points="0 0 24 0 24 24 0 24" />
                                                                                ...
                                                                                <span class="kt-menu__link-text">Styles</span>
                                                                        </a>
                                                                </li>
                                                                <li class="kt-menu__item {{ Request::is('admin/tournaments') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                                                        <a href="/admin/tournaments" class="kt-menu__link">
                                                                                <span class="kt-menu__link-icon">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                                                        <polygon id="Bound" points="0 0 24 0 24 24 0 24" />
                                                                                ...
                                                                                <span class="kt-menu__link-text">Tournaments</span>
                                                                        </a>
                                                                </li>
                                                                <li class="kt-menu__section ">
                                                                ...
                                                                <li class="kt-menu__item {{ Request::is('admin/filter') ? 'kt-menu__item--active' : '' }}" aria-haspopup="true">
                                ...
                                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                                        <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
                                                ...
                                                <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
                                                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                                                                 @if($u->superadmin)<ul class="kt-menu__nav ">
                                                                        ...
                                                                        <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here">
                                                                                <button type="button" class="btn btn-primary socketStop">Shut down the socket</button>
                                                                        </li>
                                                                </ul> @endif
                                                        </div>
                                                </div>
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                                                                        ...
                                                                        <div class="kt-notification">
                                                                                ...
                                                                                <div class="kt-notification__custom">
                                                                                        <a href="/" class="btn btn-label-brand btn-sm btn-bold">Return to site</a>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                        ...
                                        <div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
                                                <div class="kt-footer__copyright">
                                                        2022 © &nbsp;<a href="http://vk.com" target="_blank" class="kt-link">Luck2x</a>
                                                </div>
                                        </div>
