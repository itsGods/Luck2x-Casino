            ...
            <div class="right">
                <div class="affiliate-stats-item full">
                    <div class="wrap">
                            ...
                            <span id="withdraw-button" class="" data-toggle="tooltip" data-placement="top" title="Минимальная сумма снятия <?php echo e($settings->min_ref_withdraw); ?> монет"><button type="button" <?php echo e($u->ref_money < $settings->min_ref_withdraw  ? 'disabled' : ''); ?> class="btn">Take</button></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /* /home/runner/workspace/resources/views/pages/affiliate.blade.php */ ?>