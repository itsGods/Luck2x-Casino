...
<link rel="stylesheet" href="/css/mines.css?v=<?php echo e(time()); ?>">
<script src="/js/mines.js?v=<?php echo e(time()); ?>"></script>
                                ...
                                <div class="game-area-content">
                                    <div class="mines__component">
                                        <div class="mines__wrapper">
                                            <?php for($i=1;$i<=25;$i++): ?>
                                            <button type="button" class="mines__btn" data-number="<?php echo e($i); ?>">
					...
					<table class="table">
						<tbody>
							...
							<tr>
								...
								<td><?php echo e($g['bombs']); ?></td>
                <td><?php echo e($g['coef']); ?>x</td>
								<td>
									<div class="bet-number">
										<span class="bet-wrap">
											<span class="<?php echo e($g['win_sum'] > 0 ? 'win' : 'lose'); ?>"><?php echo e($g['win_sum']); ?></span>
...
<?php /* /home/runner/workspace/resources/views/pages/mines.blade.php */ ?>